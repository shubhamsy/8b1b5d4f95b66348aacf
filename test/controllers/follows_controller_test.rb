...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { followable_id: @follow.followable_id, followable_type: @follow.followable_type } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { followable_id: @follow.followable_id, followable_type: @follow.followable_type } }
